...
```Haskell
import Data.Nbt qualified as as Nbt
import Data.Nbt (Nbt) -- just because "Nbt.Nbt" looks stupid
import Data.Serialize

main :: IO ()
main = do
  shouldBeNbt <- Nbt.readCompressed "level.dat" -- see also "Nbt.readUncompressed"
  case shouldBeNbt of
